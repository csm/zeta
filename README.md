...
The page fetches `src/zeta/*.cljc`, evaluates them in a fresh wasm
REPL session, and drives everything through `repl.eval` — the SVG you
see is generated by the Clojure code, not by JavaScript.
